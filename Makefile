...
GCP_DOCKER_IMAGE_NAME = asia-south1-docker.pkg.dev/cyberbullying-428016/abhishek/abhishek-data-processing
...
push: build
	gcloud auth configure-docker --quiet aisa-south1-docker.pkg.dev
