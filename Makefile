...
SERVICE_NAME = app
CONTAINER_NAME = abhishek-data-preparation-container
...
generate-final-config: up guard-CONFIG_NAME
	$(DOCKER_COMPOSE_EXEC) python ./abhishek/generate_final_config.py --config-name $${CONFIG_NAME} --overrides  $${OVERRIDES}
