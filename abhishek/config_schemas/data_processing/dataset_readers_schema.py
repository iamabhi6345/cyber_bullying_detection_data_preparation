...
class GHCDatsetReaderConfig(DatasetReaderConfig):
    _target_: str = "abhishek.data_processing.dataset_readers.GHCDatasetReader"
    dev_split_ratio: float = MISSING


@dataclass
class JigsawToxicCommentsDatasetReaderConfig(DatasetReaderConfig):
    _target_: str = "abhishek.data_processing.dataset_readers.JigsawToxicCommentsDatasetReader"
    dev_split_ratio: float = MISSING


@dataclass
class TwitterDatasetReaderConfig(DatasetReaderConfig):
    _target_: str = "abhishek.data_processing.dataset_readers.TwitterDatasetReader"
    dev_split_ratio: float = MISSING
